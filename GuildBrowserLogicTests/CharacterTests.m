...
-(void)testCreateCharacterFromDetailJson
{
    ...
    STAssertNotNil(testGuy2, @"Could not crreate character from nil data");
...
-(void)testCreateCharacterFromDetailJsonProps
{
    ...
    STAssertEqualObjects(_testGuy.realm, @"Borean Tundra", @"realm is wrong");STAssertEqualObjects(_testGuy.achievementPoints, @3130,@"achievement points is wrong");
